...
**Prerequisiti ancora da installare:** Docker Desktop **su macchina B** (su macchina A c'è ed è stato usato). Erlang/OTP 29.0.5 + rebar3 3.27, JDK 17 e Maven 3.9.9 ci sono e funzionano.
